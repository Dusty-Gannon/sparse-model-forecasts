...
parameters{
  ...
  vector[P] beta;         // standardized coefficients before shrinkage
  vector[p] phi;          // autoregression parameters
  real<lower = 0> sigma;      // sd of the innovations

}
transformed parameters{

  vector[N] mu = X * beta;               // declare vector of means
  vector[N] err = y - mu;              // vector of residuals
