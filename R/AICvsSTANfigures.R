...
par(mar=c(5,9,2,2))
par(mfrow=c(1,1))
vioplot::vioplot(cbind(AICdecorr=decorData$RMSEaic[1:1800],AICnorm=decorData$RMSEaic[1801:3600],STANdecorr=decorData$RMSEstan[1:1800],STANnorm=decorData$RMSEstan[1801:3600]),las=1,cex.axis=0.9,names=c("Stepwise AIC\n decorrelated","Stepwise AIC\n normal","Horseshoe\n decorrelated","Horseshoe\n normal"),
